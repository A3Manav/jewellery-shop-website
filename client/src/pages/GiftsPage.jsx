...
const GiftsPage = () => {
  ...
  const {
    ...
    queryFn: () =>
      axios
        .get(
          `/api/products?type=Gift Items,Fashion Products&search=${search}&sort=${sort}&minPrice=${minPrice}&maxPrice=${maxPrice}&gender=${gender}`
        )
        .then((res) => res.data),
  });
      ...
      <div className="bg-black text-white pt-20 pb-8 md:pb-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
            Thoughtfully curated gifts and fashion items that create lasting
            memories.
            <span className="text-amber-400 font-medium">
              {" "}
              Perfect for every celebration and milestone.
            </span>
          </p>
