...
const PotsPage = () => {
  ...
  const {
    ...
    queryFn: () =>
      axios
        .get(
          `/api/products?type=Pot Items&search=${search}&sort=${sort}&minPrice=${minPrice}&maxPrice=${maxPrice}&gender=${gender}`
        )
        .then((res) => res.data),
  });
      ...
      <div className="bg-black text-white pt-20 pb-8 md:pb-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
            Authentic traditional pots and kalash for religious ceremonies and
            special occasions.
            <span className="text-amber-400 font-medium">
              {" "}
              Handcrafted with devotion and precision.
            </span>
          </p>
          ...
          {isLoading && (
            <div className="col-span-full flex items-center justify-center py-16">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-600">Loading pot items...</span>
              </div>
            </div>
          )}
